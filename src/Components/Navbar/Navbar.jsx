...
const Navbar = ({freeClaim}) => {
    return (
        <div className="">
            <div class="gap-5 place-items-center px-6 items-center  rounded-b-2xl navbar bg-base-300 font-bold grid lg:flex lg:justify-between md:flex md:justify-between md:items-center lg:text-2xl md:text-1xl">
