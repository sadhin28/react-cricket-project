    ...
    return (
        <div className='rounded-3xl mt-10 text-center'>
            <div className='flex  flex-col justify-center lg:max-w-330 md:max-w-200 mx-auto rounded-4xl bg-blend-color-burn lg:h-100 md:h-80 h-60' id="heroSection">
                ...
                <h1 className='font-bold'>Assemble My Ultimate Dream 11 Cricket Team</h1>
                <button className=' font-black rounded-xl btn mb-6 hover:bg-lime-200 mt-4 w-50 mx-auto text-center bg-[#E7FE29]'>Claim Free Credit</button>
